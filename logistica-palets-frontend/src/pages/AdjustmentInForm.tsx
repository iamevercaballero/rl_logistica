  ...
  return (
    <div
      style={{
        ...
        padding: "10px 14px",
        borderRadius: 8,
        border: `1.5px solid ${isPending ? "var(--warning)" : "var(--border)"}`,
        background: isPending ? "var(--badge-adjout-bg)" : "var(--bg)",
        cursor: "pointer",
    ...
    >
      <div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          ...
          {isPending && (
            <span className="badge badge--adj-out" style={{ fontSize: 10 }}>
              PROVISORIO
            </span>
          )}
        </div>

        {/* Línea 2: fecha + depósito + documento + proveedor */}
        <div
          style={{
            display: "flex",
            gap: 12,
